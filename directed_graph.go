...
func (g *Directed_Graph) add_Edge(u, v int64){
	g.edges[u] = append(g.edges[u], v)
	g.set_number_of_edges()
	
}

func (g *Directed_Graph) set_number_of_edges() {
	g.number_of_egdes++
}

func (g *Directed_Graph) get_number_of_edges() int64 {
	return g.number_of_egdes
}

func(g *Directed_Graph) set_vertices(u, v int64){
	if g.vertices == nil{
...
func (g *Directed_Graph) compute_in_degrees() {
